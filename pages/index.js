...
const Resume = () => {
  ...
  const achievements = [
    ...
    },
    {
      ...
      displayName: "Provincial Champion",
      entity: "Leboldus HS",
    },
  ...
  const teams = [
    ...
    { displayName: "sMedia", year: [2018, 2020], title: "Product Manager" },

    { displayName: "U of R Rams", year: [2019], title: "Assistant Coach" },
    {
